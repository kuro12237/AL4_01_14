...
#pragma region Get
	...
	static Vector4 Getcolor() { return SceneChangeAnimation::GetInstance()->color_; }
#pragma endregion
...
#pragma region Set
	...
	static void SetColor_(Vector4 c) { SceneChangeAnimation::GetInstance()->color_ = c; }
#pragma endregion
