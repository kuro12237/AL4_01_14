...
void ModelLineState::CommandCall(Model* state,const ViewProjection& viewprojection)
{
	...
	commands.m_pList->SetGraphicsRootConstantBufferView(1, state->GetWorldTransform().buffer_->GetGPUVirtualAddress());
